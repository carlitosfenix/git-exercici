...
namespace CSharp_6_DbContext_Console
{
    class Program
    {
        ...
        private static bool AlumnoAlta()
        {
            ...
            bool salida =(DbContext.RegistrarNewStudent(nombre, dni)==null)? false : true;
            return salida;
        }
        ...
        {
            DbContext.RegistrarNewStudent("Antonio Raro Raro", "44000041Y");
            DbContext.RegistrarNewStudent("Milano Reo Feo", "12345678Z");
